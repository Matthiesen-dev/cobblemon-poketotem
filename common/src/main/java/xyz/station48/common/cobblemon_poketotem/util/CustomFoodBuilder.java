...
public class CustomFoodBuilder {
    private final Optional<ItemStack> usingConvertsTo = Optional.empty();
    ...
    public @NotNull FoodProperties build() {
        ...
        return new FoodProperties(nutrition, f, canAlwaysEat, eatSeconds, this.usingConvertsTo, this.effects.build());
    }
}
